...
<div class="well well-small">
	...
	<div class="row">
		...
		<div class="control-group">
		 ...
		 <div class="control-group">
			...
			<div class="controls">
			   ...
			   <form:input type="number" class="span3" placeholder="Mời nhập số điện thoại"  path="phone" /> 
		...
		<div class="control-group">
			...
			<div class="controls">
			  <form:input type="text" class="span3" placeholder="Mời nhập số địa chỉ "  path="address" /> 
			</div>
		</div>
		
		 <div class="control-group">
			<label class="control-label"> Yêu cầu <sup>*</sup></label>
			<div class="controls">
			
			   <form:input type="text" class="span3" placeholder="Mời nhập note"  path="note" /> 
